...
{  
    [ActionNodeDefinition(Name = nameof(System_IODirectoryEnumerateFiles_String), DisplayName = "EnumerateFiles(String)", Category = "System/Directory")]
    public class System_IODirectoryEnumerateFiles_String : ActionNode 
    { 
        ...
        public override string Name => nameof(System_IODirectoryEnumerateFiles_String); 
        public override string FriendlyName => nameof(System_IODirectoryEnumerateFiles_String); 
        ...
        [DataPinDefinition(
        Id = "ba981361-b4d0-4975-96b2-bbbcde6b6b6f",
        ...
        [DataPinDefinition(
        Id = "c5c8bb1a-36e1-4b63-a549-b0a87538d8f2",
        ContainerType = DataPinContainerType.Single,
        ...
        [DataPinDefinition(
        Id = "a1f6afd5-25c3-41ee-8466-8d4f6fd149b6",
        ContainerType = DataPinContainerType.Single,
        DataType = typeof(System.String),
        Direction = PinDirection.Out,
